...
camera_matrix = np.array(([[748.20822457, 0., 498.05565029],  # 相机内参

                           [0., 748.74296266, 368.19673108],

                           [0., 0., 1., ]]), dtype=np.double)

dist_coefs = np.array([[0.05939054, -0.51605622, 0.00458489, 0.00927318, 2.03243674]], dtype=np.double)  # 畸变参数
...
# dst_point = np.float32([[74.842476, 111.54859], [511.91144, 111.54859], [234.54076, 344.6011], [356.7978, 344.6011]])
